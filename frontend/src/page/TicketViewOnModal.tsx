...
const TicketViewOnModal = ({ticket}:{ticket:ticket}) => {
  return (
    <div className='grid grid-cols-1 lg:grid-cols-2 gap-2 lg:gap-4 h-fit bg-background-base'>
      <h1 className='col-span-2 flex justify-center text-text-primary font-bold gap-2'><span className='italic font-semibold'>Ref/Tracking :</span> {ticket.ref} </h1>
 ...
 <div className='flex flex-col justify-start items-start gap-px col-span-2 '>
    <p className='text-text-primary text-xs italic font-semibold'>Message :</p>
    <p className='bg-gray-hot/50 min-h-20 w-full text-start text-md'>
 ...
 {ticket.specialFields&& <Accordion
    ...
    >
      <AccordionItem value="item-1">
        ...
        {Object.entries(ticket.specialFields)?.map(val=><div className='flex items-center gap-2'>
